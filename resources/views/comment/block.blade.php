<div class="brand-logo center"><img height="50px" src="{{URL::asset('images/Icon.png')}}" style="vertical-align: middle;"  alt="Logo"/>
    <span class="center-align shadow-text">Block-Builder</span></div>
<ul class="right">
    <li><a href="#" onclick="if (confirm('Möchtest du wirklich löschen?'))window.location = '{{Request::root()}}/block/{{$id}}/delete'"><i class="mdi-action-delete small white-text"></i></a></li>
...
<ul class="left">
    <li><a href="{{Request::root()}}/block"><i class="mdi-navigation-arrow-back small white-text"></i></a></li>
</ul>
